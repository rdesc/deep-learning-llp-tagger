...
# num of nodes to include in LSTM
# can do consecutive training with diff architectures
...
if (args.doTraining == True):
                ...
                print (model_to_do)
                train_llp(args.file_name + filename, args.useGPU2, model_to_do = model_to_do, frac=0.5)
                gc.collect()
